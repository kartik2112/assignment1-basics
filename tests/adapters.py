...
def run_multihead_self_attention(
    ...
    mha.load_state_dict({'w_qkv.weight': w_qkv, 'w_o.weight': o_proj_weight})
...
def run_multihead_self_attention_with_rope(
    ...
    """
    # raise NotImplementedError
    # from cs336_basics.model import MultiheadSelfAttention_w_RoPE
    # mha = MultiheadSelfAttention_w_RoPE(d_model, num_heads, theta, max_seq_len)
    # w_qkv = torch.cat([q_proj_weight, k_proj_weight, v_proj_weight], dim=0)
    # mha.load_state_dict({'w_qkv.weight': w_qkv, 'w_o.weight': o_proj_weight})
    # return mha(in_features, token_positions)

    from cs336_basics.model import TransformerAttention
    mha = TransformerAttention(d_model, num_heads, theta, max_seq_len)
...
def run_transformer_block(
    ...
    tb = TransformerBlock(d_model, num_heads, theta, max_seq_len, d_ff)
...
def run_transformer_lm(
    ...
    tm = TransformerLM(vocab_size, context_length, d_model, num_layers, num_heads, d_ff, rope_theta)
...
def run_get_lr_cosine_schedule(
    ...
    """
    # raise NotImplementedError
    from cs336_basics.model import cosine_schedule
